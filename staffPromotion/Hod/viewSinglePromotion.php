            ...
            <div class="card-body pt-3">
                ...
                <div class="tab-content pt-2">
                    ...
                    <div class="tab-pane fade show active profile-overview" id="profile-overview">
                        ...
                        <div class="row mb-2">
                            <div class="col-lg-3 col-md-4 label ">Name of Candidate</div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-lg-12">
                                <a href="../includes/sendPromotion_toFaculty.php?id=<?=$id?>"><button
                                        class="btn btn-secondary btn-block">Send To
                                        Faculty</button></a>
                            </div>
                        </div>
                    </div>
