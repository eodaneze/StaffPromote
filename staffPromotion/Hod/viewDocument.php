...
<main class="main" id="main">
    <div class="table-responsive text-nowrap">
        <table class="table table-borderless datatable">
            ...
            <tbody>
                <?php 
                    $uploads = "SELECT DISTINCT staffid FROM staffdoc WHERE seen = 1 AND deleted = 1";
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a href="../includes/sendfac.php?staffid=<?=$staffid?>">

                            <span class="btn btn-success"><i class="fa fa-eye" aria-hidden="true"></i> Send to Faculty</span>
                        </a>
                    </td>
                    <!-- Modal -->
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <?php 
                                        $doc = "SELECT * FROM staffdoc WHERE staffid = '$staffid' AND seen = 1 AND deleted = 1";
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            <a href="../includes/staffdoc/<?=$docget['doc']?>" class="btn btn-link">view doc</a>
                                        </div>
                                    </div>
                                    <?php } ?>
                                </div>
