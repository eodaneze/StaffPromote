<?php
  ...
  if(isset($_GET['id'])){
    $id = $_GET['id'];
    $staff = "SELECT * FROM hod WHERE id = '$id'";
                ...
                <div class="col-xl-4">
                    ...
                    <div class="card">
                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                            ...
                            <img src="./includes/hoddp/<?=$sphoto?>" alt="Profile" class="rounded-circle">
                            <h2><?=$name?></h2>
                            <h3><?=$slvl?></h3>
                        ...
                        <div class="card-body pt-3">
                            ...
                            <div class="tab-content pt-2">
                                ...
                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-8 col-lg-9">
                                            <img src="./includes/hoddp/<?=$sphoto?>" alt="Profile">
                                        </div>
                                    </div>

                                    <!-- Profile Edit Form -->
                                    <form action="includes/edithod.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="row mb-3">
                                            <label for="Email" class="col-md-4 col-lg-3 col-form-label">Profile Picture</label>
                                            <div class="col-md-8 col-lg-9">
                                ...
                                <div class="tab-pane fade pt-3" id="profile-change-password">
                                    ...
                                    <form action="includes/edithod.php" method="POST">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" name="editpass" class="btn btn-primary">Change Password</button>
                                        </div>
