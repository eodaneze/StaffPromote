...
<body class="body"
    ...
    <!-- <div class="container">
        <div class="logo d-flex mt-5">
            <a href="./index.php" class="d-flex">
                <img src=" ./assets/img/logo.png" alt="">
                <h5 class="text-white">Staff Promote</h5>
            </a>
        </div>
    </div> -->
    <main>
                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form class="row g-3 needs-validation" novalidate action="./includes/adminlogin.php"
                                        method="POST">
                                        ...
                                        <div class="col-12">
                                            <p class="small mb-0">Don't have account? <a
                                                    href="./Adminregister.php">Create an
                                                    account</a></p>
                                        </div>
                                    </form>
